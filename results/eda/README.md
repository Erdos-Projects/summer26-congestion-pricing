...
| `yellow_full_burden_by_distance.png` | Charged share + median base-cost burden by distance bucket (full EDA §10) | The fee is a larger share of short, low-cost trips. |
...
| `hvfhv_full_distance_exposure_2025.png` | Charged share + median burden by distance bucket (full EDA §9) | The fee is a larger share of short, low-cost trips, as for Yellow. |
